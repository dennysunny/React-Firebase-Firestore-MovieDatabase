...
<p>Last updated: April 14, 2020</p>
...
<ul>
    ...
    <li>
        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to The-Movie Buzz.</p>
          </li>
      <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
    <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
  <li><strong>Website</strong> refers to The-Movie Buzz, accessible from http://reactfirebasetmr.firebaseapp.com</li>        <li><strong>Service</strong> refers to the Website.</li>
...
<ul>
          <li>By visiting this page on our website: http://reactfirebasetmr.firebaseapp.com</li>
      </ul>
    </div>
